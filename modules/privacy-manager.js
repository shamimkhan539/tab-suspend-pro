// Privacy and Data Management Module for Tab Suspend Pro
class PrivacyManager {
    ...
    async clearAllData() {
        if (
            !confirm(
                "Are you sure you want to clear all Tab Suspend Pro data? This cannot be undone."
            )
        ) {
            return false;
        }
        ...
        try {
            ...
            console.log("All Tab Suspend Pro data cleared");
            return true;
        } catch (error) {
        ...
        try {
            ...
            const exportData = {
                ...
                privacy: {
                    ...
                    notice: "This export contains all data stored by Tab Suspend Pro. Handle with care.",
                },
            };
